        ...
        <div className="flex flex-row bg-white rounded-2xl shadow-xl mt-8 h-full">
          <div className="flex-1 relative pt-8 px-12 pb-8 md:px-8">
            <p className="mt-4 ml-3 text-base text-gray-500">
              Hi there! Thanks for visiting! I{`'`}m pretty busy these days much
              like everyone else. If you need to get in touch please do so!
            </p>
            ...
            <p className="mt-4 ml-3 mb-3 text-base text-gray-500">
              I{`'`}m not interested in SEO, app development, web development or
              any other service that you might be intending to offer, so please
              save your time by not sending this to me.
            </p>
            <p className="mt-4 ml-3 mb-3 text-base text-gray-500">
